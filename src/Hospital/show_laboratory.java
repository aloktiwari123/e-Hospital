 ...
 * @author alokt
 */
public class show_laboratory extends javax.swing.JFrame {

    /**
     * Creates new form show
     */
    public show_laboratory() {
        initComponents();
        upDateDB();
    ...
    public void upDateDB()
    {
    	try {
    		conn cc=new conn();
    		String query1="SELECT * FROM laboratory";
    		...
    		while(rs.next())
    		{
    			...
    			for (i=1;i<=q;i++)
    			{
    				columnData.add(rs.getString("lab_id"));
    				columnData.add(rs.getString("name"));
    				columnData.add(rs.getString("specification"));
    				columnData.add(rs.getString("equipments"));
    			}
    ...
    {
    	jtxt_labid.setText("");
		jtxt_labname.setText("");
		jtxt_specification.setText("");
		jtxt_equipments.setText("");
		//jtxt_ward.setText("");
    }
    ...
    private void initComponents() {
        ...
        jtxt_labid = new javax.swing.JTextField();
        jtxt_labname = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        jLabel4 = new javax.swing.JLabel();
        jtxt_specification = new javax.swing.JTextField();
        jLabel5 = new javax.swing.JLabel();
        jtxt_equipments = new javax.swing.JTextField();
        ...
        jTable1.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent arg0) {
        		...
        		jtxt_labid.setText(RecordTable.getValueAt(Selectedrow,0).toString());
        		jtxt_labname.setText(RecordTable.getValueAt(Selectedrow,1).toString());
        		jtxt_specification.setText(RecordTable.getValueAt(Selectedrow,2).toString());
        		jtxt_equipments.setText(RecordTable.getValueAt(Selectedrow,3).toString());
        ...
        jLabel2.setText("Laboratory ID");

        jtxt_labid.setFont(new java.awt.Font("Tahoma", 1, 24));
        

        jtxt_labname.setFont(new java.awt.Font("Tahoma", 1, 24));
        ...
        jtxt_specification.setFont(new java.awt.Font("Tahoma", 1, 24));

        jLabel5.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
        jLabel5.setText("Equipments");

        jtxt_equipments.setFont(new java.awt.Font("Tahoma", 1, 24));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtxt_labname, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxt_specification, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxt_equipments, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jtxt_labid, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(123, 123, 123)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jtxt_labid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel2))
                        .addGap(21, 21, 21)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(jtxt_labname, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(26, 26, 26)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jtxt_specification, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel4))
                        .addGap(28, 28, 28)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel5)
                            .addComponent(jtxt_equipments, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jLabel1.setText("Laboratory Info");
        ...
        jTable1.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"Laboratory ID", "Lab Name", "Specification", "Equipments"
        	}
        ));
        ...
        jPanel5Layout.setHorizontalGroup(
        	jPanel5Layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(jPanel5Layout.createSequentialGroup()
        			...
        			.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 1149, GroupLayout.PREFERRED_SIZE)
        			.addGap(152))
        );
    ...
    private void jbtn_addActionPerformed(ActionEvent evt) {
		...
		try {
    		...
    		//ResultSet rs=cc.st.executeQuery(query1);
    		pst=cc.c.prepareStatement("insert into laboratory(lab_id,name,specification,equipments)value(?,?,?,?)");
    		
    		pst.setString(1,jtxt_labid.getText());
    		pst.setString(2,jtxt_labname.getText());
    		pst.setString(3,jtxt_specification.getText());
    		pst.setString(4,jtxt_equipments.getText());
    ...
    private void jbtn_updateActionPerformed(ActionEvent evt) {
		...
		try {
    		conn cc=new conn();
    		pst=cc.c.prepareStatement("update laboratory set lab_id=?,name=?,specification=?,equipments=? where lab_id=?");
    		DefaultTableModel RecordTable=(DefaultTableModel)jTable1.getModel();
    		int Selectedrow=jTable1.getSelectedRow();
    ...
    private void jbtn_deleteActionPerformed(ActionEvent evt) {
		...
		try
		{
			...
			{
				conn cc=new conn();
				pst=cc.c.prepareStatement("delete from laboratory where lab_id=?");
			    pst.setString(1,id);
				pst.executeUpdate();
				JOptionPane.showMessageDialog(this,"Record Updated");
				upDateDB();
    ...
    private void jbtn_exitActionPerformed(ActionEvent evt) {
    	...
    	if(JOptionPane.showConfirmDialog(frame,"Confirm you want to exit","Doctor Info",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
    	{
    		...
    		new doctors();
    		show_laboratory.this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(show_laboratory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField jtxt_labid;
    private javax.swing.JTextField jtxt_labname;
    private javax.swing.JTextField jtxt_specification;
    private javax.swing.JTextField jtxt_equipments;
