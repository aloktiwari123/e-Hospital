 ...
 * @author alokt
 */
public class show_facility extends javax.swing.JFrame {

    /**
     * Creates new form show
     */
    public show_facility() {
        initComponents();
        upDateDB();
    ...
    public void upDateDB()
    {
    	try {
    		...
    		while(rs.next())
    		{
    			...
    			for (i=1;i<=q;i++)
    			{
    				columnData.add(rs.getString("facility_id"));
    				columnData.add(rs.getString("name"));
    				columnData.add(rs.getString("description"));
    				columnData.add(rs.getString("price"));
    				columnData.add(rs.getString("availablity"));
    			}
    ...
    {
    	jtxt_facilityid.setText("");
		jtxt_name.setText("");
		jtxt_des.setText("");
		jtxt_price.setText("");
		jtxt_availability.setText("");
    }
    /**
    ...
    private void initComponents() {
        ...
        jtxt_facilityid = new javax.swing.JTextField();
        ...
        jtxt_availability = new javax.swing.JTextField();
        ...
        jTable1.addMouseListener(new MouseAdapter() {
        	...
        	public void mouseClicked(MouseEvent arg0) {
        		...
        		jtxt_facilityid.setText(RecordTable.getValueAt(Selectedrow,0).toString());
        		jtxt_name.setText(RecordTable.getValueAt(Selectedrow,1).toString());
        		jtxt_des.setText(RecordTable.getValueAt(Selectedrow,2).toString());
        		jtxt_price.setText(RecordTable.getValueAt(Selectedrow,3).toString());
        		jtxt_availability.setText(RecordTable.getValueAt(Selectedrow,4).toString());
        	}
        });
        ...
        jtxt_facilityid.setFont(new java.awt.Font("Tahoma", 1, 24));
        ...
        jtxt_des.setFont(new java.awt.Font("Tahoma", 1, 24));
        ...
        jtxt_availability.setFont(new java.awt.Font("Tahoma", 1, 24));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jtxt_name, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtxt_des, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addComponent(jtxt_availability, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jLabel2, javax.swing.GroupLayout.PREFERRED_SIZE, 168, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(jtxt_facilityid, javax.swing.GroupLayout.PREFERRED_SIZE, 608, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(123, 123, 123)
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jtxt_facilityid, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jtxt_des, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel4))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jtxt_availability, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel6)))
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(jPanel4, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jTable1.setModel(new DefaultTableModel(
        	...
        	new String[] {
        		"Facility ID", "Name", "Description", "Price", "Availability"
        	}
        ));
        ...
        jPanel5Layout.setHorizontalGroup(
        	jPanel5Layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(jPanel5Layout.createSequentialGroup()
        			...
        			.addComponent(jScrollPane1, GroupLayout.PREFERRED_SIZE, 1150, GroupLayout.PREFERRED_SIZE)
        			.addGap(151))
        );
        ...
        jPanel1Layout.setVerticalGroup(
        	jPanel1Layout.createParallelGroup(Alignment.TRAILING)
        		.addGroup(jPanel1Layout.createSequentialGroup()
        			...
        			.addGap(18)
        			.addComponent(jPanel5, GroupLayout.PREFERRED_SIZE, 282, GroupLayout.PREFERRED_SIZE)
        			.addGap(29))
        );
    ...
    private void jbtn_updateActionPerformed(ActionEvent evt) {
    	...
    	try {
    		conn cc=new conn();
    		pst=cc.c.prepareStatement("update facility set facility_id=?,name=?,description=?,price=?,availablity=? where facility_id=?");
    		DefaultTableModel RecordTable=(DefaultTableModel)jTable1.getModel();
    		int Selectedrow=jTable1.getSelectedRow();
    		id=RecordTable.getValueAt(Selectedrow,0).toString();
    		
    		pst.setString(1,jtxt_facilityid.getText());
    		pst.setString(2,jtxt_name.getText());
    		pst.setString(3,jtxt_des.getText());
    		pst.setString(4,jtxt_price.getText());
    		pst.setString(5,jtxt_availability.getText());
    		pst.setString(6,id);
    ...
    private void jbtn_addActionPerformed(ActionEvent evt) {
    	...
    	try {
    		...
    		//ResultSet rs=cc.st.executeQuery(query1);
    		pst=cc.c.prepareStatement("insert into facility(facility_id,name,description,price,availablity)value(?,?,?,?,?)");
    ...
    private void jbtn_exitActionPerformed(ActionEvent evt) {
    	...
    	if(JOptionPane.showConfirmDialog(frame,"Confirm you want to exit","Facility Info",JOptionPane.YES_NO_OPTION)==JOptionPane.YES_OPTION)
    	{
    		
    		new facilites();
    		show_facility.this.setVisible(false);
    ...
    private void jbtn_deleteActionPerformed(ActionEvent evt) {
		...
		try
		{
			...
			{
				conn cc=new conn();
				pst=cc.c.prepareStatement("delete from facility where facility_id=?");
			    pst.setString(1,id);
				pst.executeUpdate();
				JOptionPane.showMessageDialog(this,"Record Updated");
				upDateDB();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(show_facility.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
