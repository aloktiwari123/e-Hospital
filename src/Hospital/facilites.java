...
public class facilites implements ActionListener {
	...
	facilites(){
		...
		JLabel lid = new JLabel("FACILITY SECTION"); // blinking label
		lid.setBounds(100,40,1140,100);
		...
		b2 = new JButton("Existing Facility List");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==b2)
		{
			new show_facility().setVisible(true);;
			frame.setVisible(false);
		}
